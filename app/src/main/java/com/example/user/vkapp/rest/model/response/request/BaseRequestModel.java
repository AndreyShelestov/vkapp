package com.example.user.vkapp.rest.model.response.request;

import com.example.user.vkapp.CurrentUser;
import com.example.user.vkapp.consts.ApiConstants;
...
public abstract class BaseRequestModel {
    ...
    public Map<String, String> toMap() {
        ...
        if (accessToken != null) {
            map.put(VKApiConst.ACCESS_TOKEN, String.valueOf(getAccessToken()));
        }
        onMapCreate(map);
        return map;
    }
